                    ...
                    >
                        ...
                        <div class="playlist__header__info">
                            ...
                            <div class="playlist__header__info__summary">
                                <router-link
                                    :to="{ path: `/artist/${release.singers[0].id}` }"
                                ...
                                >
                                    ...
                                    <span href="#">{{ release.singers[0].name }}</span>
                                </router-link>
                                <p class="playlist__header__info__summary__count">
                                    | {{ release.songs.length }} трека |
                                </p>
                                <p class="playlist__header__info__summary__count">
...
export default {
    computed: {
        ...
        filteredSongs() {
            ...
            return this.release.songs.filter(song =>
        ...
        totalDuration() {
            if (!this.release?.songs) return '0:00';

            const totalSeconds = this.release.songs.reduce((acc, song) => acc + song.duration, 0);
